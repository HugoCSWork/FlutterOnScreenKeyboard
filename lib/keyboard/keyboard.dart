...
import 'package:test_on_screen_keyboard/keyboard/key.action.dart';
import 'package:test_on_screen_keyboard/keyboard/key.type.dart';
import 'package:test_on_screen_keyboard/keyboard/keyboard.type.dart';
import 'package:test_on_screen_keyboard/keyboard/keys.dart';
...
class _VirtualKeyboardState extends State<VirtualKeyboard> {
  ...
  void _onKeyPress(VirtualKeyboardKey key) {
    if (key.keyType == VirtualKeyboardKeyType.String) {
      ...
      cursorPosition =
          TextSelection(baseOffset: cursorPosition!.baseOffset + 1, extentOffset: cursorPosition!.extentOffset + 1);
      ...
      switch (key.action) {
        case VirtualKeyboardKeyAction.Backspace:
          ...
          textController.text = cursorPosition!.start == text.length
              ...
              : text.substring(0, cursorPosition!.start - 1) + text.substring(cursorPosition!.start);
          cursorPosition =
              TextSelection(baseOffset: cursorPosition!.baseOffset - 1, extentOffset: cursorPosition!.extentOffset - 1);
          break;
